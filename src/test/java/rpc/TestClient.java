...
public class TestClient {
	...
	public void start() throws InstantiationException, IllegalAccessException {
		ServiceFactory.factory.setSerialize(new FastJsonSerialize()).init(new String[]{"127.0.0.1:8808","127.0.0.1:8809"});
	...
	public void testThread() throws InstantiationException, IllegalAccessException, InterruptedException {
		...
		for(int i=0; i<threadNum; i++) {
			...
			ts.add(new Thread(() -> {
				...
				if(!"return testM(arg1)".equals(data)) {
			...
			ts.add(new Thread(() -> {
				...
				if(!"return testM(1, arg2)".equals(data)) {
			...
			ts.add(new Thread(() -> {
				...
				if(!"return testM(arg3, 2)".equals(data)) {
			...
			ts.add(new Thread(() -> {
				...
				if(!"return testM2(3, arg4)".equals(data)) {
